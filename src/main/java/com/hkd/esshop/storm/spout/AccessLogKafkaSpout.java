package com.hkd.esshop.storm.spout;
...
public class AccessLogKafkaSpout extends BaseRichSpout {
	...
	private void startKafkaConsumer() {
        ...
        props.put("zookeeper.connect", "192.168.235.141:2181,192.168.235.142:2181,192.168.235.143:2181");
	...
	private class KafkaMessageProcessor implements Runnable {
		...
		public void run() {
	        ...
	        while (it.hasNext()) {
	        	...
	        	LOGGER.info("[spout收到一条数据]"+message);
	        	try {
					queue.put(message);
